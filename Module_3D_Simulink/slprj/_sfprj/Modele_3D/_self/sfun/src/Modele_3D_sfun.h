#ifndef __Modele_3D_sfun_h__
#define __Modele_3D_sfun_h__
...
extern mxArray* load_Modele_3D_optimization_info(boolean_T isRtwGen, boolean_T
  isModelRef, boolean_T isExternal);
extern void unload_Modele_3D_optimization_info(void);
